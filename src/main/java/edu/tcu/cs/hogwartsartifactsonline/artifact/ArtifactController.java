...
public class ArtifactController {
    ...
    public Result findArtifactById(@PathVariable String artifactId){
        ...
        return new Result(true, StatusCode.SUCCESS, "Find One Sucess", foundArtifact);
    }

    @GetMapping
    public Result findAllArtfacts(){
        ...
        return new Result(true, StatusCode.SUCCESS, "Find All Sucess", artifactDtos);
    }
