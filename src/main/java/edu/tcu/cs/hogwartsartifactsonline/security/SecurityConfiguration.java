...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(CustomBearerTokenAccessDeniedHandler customBearerTokenAccessDeniedHandler, CustomBasicAuthenticationEntryPoint customBasicAuthenticationEntryPoint) throws NoSuchAlgorithmException {
